...
function AdminPage() {
  ...
  useEffect(() => {
    setIsAdmin(user.data.authorities === 'ADMIN')
    handleGetUsers()
    handleGetOrders()
  }, [])
  ...
  const handleGetUsers = async () => {
    ...
    try {
      const response = await gtaApi.getUsers(user)
  ...
  const handleDeleteUser = async (username) => {
    try {
      await gtaApi.deleteUser(user, username)
      handleGetUsers()
    } catch (error) {
      handleLogError(error)
    }
  ...
  const handleSearchUser = async () => {
    ...
    try {
      const response = await gtaApi.getUsers(user, username)
  ...
  const handleGetOrders = async () => {
    ...
    try {
      const response = await gtaApi.getOrders(user)
  ...
  const handleDeleteOrder = async (isbn) => {
    try {
      await gtaApi.deleteOrder(user, isbn)
      handleGetOrders()
    } catch (error) {
      handleLogError(error)
    }
  ...
  const handleCreateOrder = async () => {
    ...
    try {
      await gtaApi.createOrder(user, order)
      handleGetOrders()
      setOrderDescription('')
    } catch (error) {
      handleLogError(error)
  ...
  const handleSearchOrder = async () => {
    ...
    try {
      const response = await gtaApi.getOrders(user, text)
      setOrders(response.data)
    } catch (error) {
      handleLogError(error)
      setOrders([])
